  ...
  render() {
    return (
      <div>
        ...
        <p>
          [sign up to be a facilitator button] [I'd like to send out a message
          requesting equipment for someone button]
        </p>
        <p>
          <strong>Supplier:</strong>
        </p>
        <p>
          These are local organizations that have equipment that is suitable for
          donation. The IT department would sign up to be a supplier usually.
          This process is green and there is no charge for using bop-IT.
        </p>
